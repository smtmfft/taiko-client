...
// TaikoDataEnclaveReport is an auto generated low-level Go binding around an user-defined struct.
type TaikoDataEnclaveReport struct {
	CpuSvn     [16]byte
	MiscSelect [4]byte
	Reserved1  [28]byte
	Attributes [16]byte
...
// TaikoDataHeader is an auto generated low-level Go binding around an user-defined struct.
type TaikoDataHeader struct {
	Version            [2]byte
...
// TaikoDataParsedCertificationData is an auto generated low-level Go binding around an user-defined struct.
type TaikoDataParsedCertificationData struct {
	CertType             uint16
	CertDataSize         uint32
	DecodedCertDataArray [3][]byte
}

// TaikoDataParsedECDSAQuoteV3AuthData is an auto generated low-level Go binding around an user-defined struct.
type TaikoDataParsedECDSAQuoteV3AuthData struct {
	Ecdsa256BitSignature []byte
	EcdsaAttestationKey  []byte
	PckSignedQeReport    TaikoDataEnclaveReport
	QeReportSignature    []byte
	QeAuthData           TaikoDataParsedQEAuthData
	Certification        TaikoDataParsedCertificationData
}

// TaikoDataParsedQEAuthData is an auto generated low-level Go binding around an user-defined struct.
type TaikoDataParsedQEAuthData struct {
	ParsedDataSize uint16
	Data           []byte
}

// TaikoDataParsedV3QuoteStruct is an auto generated low-level Go binding around an user-defined struct.
type TaikoDataParsedV3QuoteStruct struct {
	Header             TaikoDataHeader
	LocalEnclaveReport TaikoDataEnclaveReport
	V3AuthData         TaikoDataParsedECDSAQuoteV3AuthData
}
...
// Approve is a paid mutator transaction binding the contract method 0x433cf1b5.
//
// Solidity: function approve((bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint24,uint24,uint16,bool,bytes32) meta, (bytes32,bytes32,bytes32,bytes32) tran, (uint16,bytes,((bytes2,bytes2,bytes4,bytes2,bytes2,bytes16,bytes20),(bytes16,bytes4,bytes28,bytes16,bytes32,bytes32,bytes32,bytes,uint16,uint16,bytes,bytes),(bytes,bytes,(bytes16,bytes4,bytes28,bytes16,bytes32,bytes32,bytes32,bytes,uint16,uint16,bytes,bytes),bytes,(uint16,bytes),(uint16,uint32,bytes[3])))) proof) returns(bool approved)
